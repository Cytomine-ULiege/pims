...
def test_get_output_dimensions():
    ...
    actual = get_thumb_output_dimensions(
        FakeImage(1000, 2000),
        width=20,
        length=3,
        height=500,
    )
    assert actual == (250, 500)
...
def test_safeguard_output_dimensions():
    actual = safeguard_output_dimensions(SafeMode.UNSAFE, 100, 10000, 10000)
    assert actual == (10000, 10000)

    actual = safeguard_output_dimensions(SafeMode.SAFE_RESIZE, 100, 10, 99)
    assert actual == (10, 99)

    actual = safeguard_output_dimensions(SafeMode.SAFE_RESIZE, 100, 1000, 2000)
    assert actual == (50, 100)

    actual = safeguard_output_dimensions(SafeMode.SAFE_RESIZE, 100, 2000, 1000)
